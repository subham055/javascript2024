...
const margedArr1 = vowels.concat(evenNumbers2);  // Marge both the arrays 

console.log(margedArr1);  
// O/P = ['A', 'E', 'I', 'O', 'U', 2, 4, 6, 8, 10]


const margedArr2 = evenNumbers2.concat(vowels);

console.log(margedArr2);
...
console.log( evenNumbers2.indexOf(3) );  // O/P = -1  coz 3 isnot present in evenNumber2 array
